function [mutRates,times,stopFlag] = findRatesEMorder1(stree,AM,mutOrders,minRate,maxRate,maxTime,maxIter,eps)
stopFlag = 0;
m = size(stree,2);
deg = zeros(1,m);
for i = 1:m
...
%     [newTime,newL] = fmincon(l,currTime,A,rhs,[],[],lb,ub,[],options);
    ...
    [mutOrdersOpt,newTime, newL] = findRatesRecPar(stree,currTheta, minRate,maxRate,eps, AM);
